        ...
        <div class="col-md-8">
            <ul id="goodsList">
                <c:forEach items="${pageBean.list}" var="goods">
                    <li>
                        <div class="mainDiv">
                            <a href="detail.html"><img src="${goods.image}" /></a>
                            <p class="book_title">${goods.name}</p>
                            <blockquote>
                                <p class="lead book_title" class="author">${goods.author}</p>
                            </blockquote>
                            <p class="price">￥${goods.salesprice}</p>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <ul class="pagination pagination-lg" id="paging">
                ...
                <li><a href="#" onclick="assignPage(${num})">${num}</a></li>
                </c:forEach>
                <li><a href="#" onclick="lastPage()">尾页</a></li>
                <span>当前第<span>${pageBean.pageNo}</span>页/共<span id="total">${pageBean.pages}</span>页</span>
