				 ...
				 <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				   ...
				   <div class="panel panel-default">
				     ...
				     <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
				       <div class="list-group">
						   <div class="div1">
							   <a href="${pageContext.request.contextPath}/PersonalAddress"><p class="p2">地址管理</p></a>
						   </div>
				       </div>
							 ...
							 <c:forEach items="${personalOrderList}" var="orderlist">
									 ...
									 <tr>
										 ...
										 <c:if test="${orderlist.status == '0'}">
											 <td>
												 <a href="${pageContext.request.contextPath}/PersonalOrderDetailServlet?id=${orderlist.id}">待付款</a>
											 </td>
										 </c:if>
...
<%--							 </tr>--%>
							 <tr>
								 ...
								 <td>
									 ...
									 <a href="#"><button type="button" class="btn btn-primary">尾页</button></a>
								 </td>
								 <td><a href="#"><button type="button" class="btn btn-danger">当前第1页/共1页</button></a></td>
							 </tr>
						 </table>
					 </div>
				 </div>
