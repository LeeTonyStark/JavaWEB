...
<html lang="zh-CN">
  <head>
    ...
    <title>个人中心订单支付页</title>

    <!-- Bootstrap -->
    <link rel="stylesheet" href="../css/bootstrap.min.css">
	<link rel="stylesheet" href="../css/personal_order_detail.css">
			 ...
			 <div class="col-md-8">
				 ...
				 <div class="row div6">
					 <div class="col-md-12">
						 ...
						 <div style="border-bottom: 4px solid red;" class="div6">
					 ...
					 <div class="col-md-12">
						 <div class="panel panel-default">
						   <div class="panel-heading">
							   <span class="span3"><strong>订单号:</strong>${oneOrderByOrderId.orderno}</span>
							   <span class="span3"><strong>下单日期:</strong>${oneOrderByOrderId.ordertime}</span>
							   <c:if test="${oneOrderByOrderId.status == 0}">
								   <span class="span3"><strong>状态:</strong>待付款</span>
							   </c:if>
							   <c:if test="${oneOrderByOrderId.status == 1}">
								   <span class="span3"><strong>状态:</strong>已支付</span>
							   </c:if>
						   </div>
							   <button type="button" class="btn btn-warning btn1"><span>取消订单</span></button>

							 <form action="${pageContext.request.contextPath}/OrderInfoServlet" method="post">
								 <input type="hidden" name="WIDout_trade_no" value="${oneOrderByOrderId.orderno}"/>
								 <input type="hidden" name="WIDtotal_amount" value="${oneOrderByOrderId.money}"/>
								 <button type="submit" class="btn btn-success btn1"><span>立即付款</span></button>
							 </form>
				 ...
				 <div class="row">
					 <div class="col-md-12">
						 <table class="table table-hover">
							 ...
							 <tr>
								 <td><span>收货人:</span></td>
								 <td><span>lisi</span></td>
								 <td></td>
								 <td></td>
							 </tr>
							 <tr>
								 <td><span>地址</span></td>
								 <td><span>四川成都市金牛区营门口路520号</span></td>
								 <td></td>
								 <td></td>
							 </tr>
							 <tr>
								 <td><span>手机号码</span></td>
								 <td><span>13574598213</span></td>
								 <td></td>
								 <td></td>
							 </tr>
							 <tr>
				 ...
				 <div class="row">
					 <div class="col-md-12">
						 <table class="table table-hover">
							 ...
							 <tr>
								  <td>
									  <img class="img1" src="../img/book6.png" />
								  </td>
								  <td colspan="2">
									  <div class="div1">
										  <span>一人之下I</span>
				 ...
				 <div class="row">
					 <div class="col-md-12">
						 <table class="table">
							 <tr>
								 <th>
									 <p class="text-right">订单支付总金额:<span style="color: red;">69.8</span></p>
								 </th>
							 </tr>
						 </table>
					 </div>
