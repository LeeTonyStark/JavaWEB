...
<html lang="zh-CN">
  <head>
	...
	<link rel="stylesheet" href="../css/personal_headimage.css">
					 ...
					 <div class="col-md-12">
						 ...
						 <div style="border-bottom: 4px solid red;width: 100%;height: 48px;margin-bottom: 30px;">
							 <button type="button" class="btn btn-danger">
								 <span style="font-size: 24px;"><strong>用户头像修改</strong></span>
							 </button>
						 </div>
						 ...
						 <div class="container-fluid">
							 <div class="row">
								 ...
								 <div class="col-md-7">
									 ...
									 <input type="file" value="选择文件"/>未选择任何文件
								 </div>
							 </div>
							 <div class="row">
								 ...
								 <div class="col-md-4">
									 ...
									 <div style="width: 250%;height: 100px;margin-top: 100px;">
